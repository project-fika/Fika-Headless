...
namespace Fika.Headless.Patches
{
    public class SettingsPatch : FikaPatch
    {
        ...
        {
            return typeof(GClass2133).GetMethod(nameof(GClass2133.smethod_2));
        }
    ...
    public static class FikaHeadlessSettingsManager
    {
        ...
        {
            await Class1725.smethod_5("LoadUserSettings", false);
        ...
        internal static async Task SetSettings(SharedGameSettingsClass gameSettings)
        {
            ...
            {
                AspectRatio = Class1723.smethod_0(new(1024, 768)),
                Display = 0,
